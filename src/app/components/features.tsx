              ...
              >
                <span className="flex">
                  ...
                  <span className="grow ml-6">
                    ...
                    <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                      Keep your audience engaged and attentive. Attendees can
                      easily participate in polls using their smartphones or
                      tablets, making it convenient and accessible.
                    </span>
                  </span>
                </span>
              </button>
              ...
              >
                <span className="flex">
                  ...
                  <span className="grow ml-6">
                    ...
                    <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-gray-200">
                      Watch the data roll in as participants vote. LivePoll Pro
                      instantly compiles and displays results, allowing you to
                      interpret and share findings with your audience immediatel
                    </span>
                  </span>
                </span>
              </button>
